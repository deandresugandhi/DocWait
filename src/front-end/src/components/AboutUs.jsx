    ...
    <>
      <div className='is-fullwidth is-flex is-flex-direction-column ml-3'>
        ...
        <div className="box is-fullwidth is-fullheight has-background-light large-rounded-box is-flex is-flex-direction-column">
          <h1 className='is-size-2-mobile is-size-2-tablet has-text-weight-bold'>Our Mission</h1>
          <p class="is-size-5 is-three-fourth-width has-text-weight-light">
          ...
          <h1 className='is-size-2-mobile is-size-2-tablet has-text-weight-bold'>Our Team</h1>
          <p class="is-size-5 is-three-fourth-width has-text-weight-light">
            <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
            <span>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in </span>
            <span>reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, </span>
